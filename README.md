...
| Field | Value |
| --- | --- |
| **Name** | `github-publish-skill-skill` |
...
Publish individual Hermes Agent skills as standalone public GitHub repositories with bilingual README.md + SKILL.md. Covers repo creation, content formatting, badge usage, and push automation via cron.
...
cp -r github-publish-skill ~/.hermes/skills/github-publish-skill/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/github-publish-skill-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/github-publish-skill-skill.git ~/.hermes/skills/github-publish-skill/
```
...
```text
skill_view(name="github-publish-skill")
```
...
```text
Use the github publish skill skill to <describe your specific task here>
```
...
```text
Gunakan skill github publish skill untuk <deskripsikan tugas spesifik Anda di sini>
```
